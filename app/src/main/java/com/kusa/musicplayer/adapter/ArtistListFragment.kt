...
class ArtistListFragment : Fragment(R.layout.fragment_list_simple) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        vm.artists.observe(viewLifecycleOwner) { artists ->
            val adapter = ArrayAdapter(requireContext(), android.R.layout.simple_list_item_1, artists)
